...
import { ArrowLeft, Lock, Mail, User, ShieldCheck, CheckCircle2, ArrowRight } from "lucide-react";
          ...
          <div className="p-8 lg:p-12 bg-gradient-to-br from-[#C25E38]/10 via-[#E06D43]/5 to-transparent border-b lg:border-b-0 lg:border-r border-[#E8E1D7] dark:border-[#38332E] flex flex-col justify-between relative">
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-xs sm:text-sm text-[#5C4F45] dark:text-[#D4C7B8] leading-relaxed">
                  Create a free account to explore unadulterated Bhagavad Gita wisdom, AI verse exegesis, and Veducation resources.
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-[#DFD5C6]/60 dark:border-[#38332E]/60 space-y-3 text-xs text-[#6B5E55] dark:text-[#A89F91]">
              <div className="flex items-start gap-2.5">
                ...
                <span>Zero Sectarian Bias: Authentic unadulterated Sanskrit sources</span>
              </div>
              <div className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-[#C25E38] dark:text-[#E06D43] shrink-0 mt-0.5" />
                <span>Free Forever Access to Gita Press & Veducation Digital Library</span>
              </div>
              <div className="flex items-start gap-2.5">
                <CheckCircle2 className="w-4 h-4 text-[#C25E38] dark:text-[#E06D43] shrink-0 mt-0.5" />
                <span>Personalized AI Guidance for daily life & practical duty</span>
              </div>
            </div>
          </div>
          ...
          <div className="p-8 lg:p-12 flex flex-col justify-center">
            <div className="mb-6">
              ...
              <p className="text-xs text-[#8C7B70] dark:text-[#A89F91] mt-1">
                Enter your details or register with Google.
              </p>
            </div>

            {/* Real Google Sign Up via NextAuth */}
            <button
              type="button"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <User className="w-4 h-4 text-[#8C7B70] dark:text-[#A89F91] absolute left-3.5 top-3.5" />
                  <input
                    type="text"
                    required
                    value={name}
                    ...
                    placeholder="Arjuna"
                    className="w-full bg-[#EFE9DF]/60 dark:bg-[#1C1917] border border-[#DFD5C6] dark:border-[#38332E] rounded-xl pl-10 pr-4 py-3 text-xs text-[#2D2622] dark:text-[#F5F2EB] placeholder-[#8C7B70] focus:outline-none focus:border-[#C25E38] dark:focus:border-[#E06D43] transition font-sans"
                  />
                </div>
              </div>
              ...
              <div className="flex items-start gap-2 pt-1">
                <input
                  ...
                  className="mt-0.5 rounded border-[#DFD5C6] dark:border-[#38332E] text-[#C25E38] focus:ring-[#C25E38] dark:bg-[#1C1917]"
                />
                <label htmlFor="terms" className="text-[11px] text-[#5C4F45] dark:text-[#D4C7B8] leading-tight cursor-pointer">
                  I agree to the Terms of Service & Privacy Policy of NityaGeeta Platform.
                </label>
              </div>
              ...
              <div className="pt-3">
                <InteractiveHoverButton
                  type="submit"
                  text={isLoading ? "Creating Account..." : "Create Free Account"}
