...
def extract_sadhak_sanjeevani(input_path, output_path, start_page=1, end_page=None):
    """
    Performs OCR on Sadhak Sanjeevani PDF page-by-page, storing progress in memory,
    and writing to a single JSON file at the end (or periodically for backups).
    """
    ...
    for page_num in range(start_page, end_page + 1):
        ...
        try:
            ...
            # so we don't lose progress if the computer reboots
            if page_num % 10 == 0:
...
def main():
    input_file = "./data/raw/gita_editions/Gita-Sadhak-Sanjevani-English.pdf"
    output_file = "./data/output/sadhak_sanjeevani_ocr.json"

    print("=" * 80)
    print("                NITYAGEETA - SADHAK SANJEEVANI OCR EXTRACTOR")
    ...
    extract_sadhak_sanjeevani(input_file, output_file, start_page=1, end_page=None)
    print("=" * 80)
