...
def extract_gita_press(input_path, output_path, start_page=1, end_page=None):
    """
    Performs OCR on Gita Press PDF page-by-page, storing progress in memory,
...
def main():
    input_file = "./data/raw/gita_editions/Srimad Bhagavad Gita Press Gorakhpur.pdf"
    output_file = "./data/output/gita_press_ocr.json"

    print("=" * 80)
    print("                NITYAGEETA - GITA PRESS OCR EXTRACTOR")
    ...
    extract_gita_press(input_file, output_file, start_page=1, end_page=None)
    print("=" * 80)
