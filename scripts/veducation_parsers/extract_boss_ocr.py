...
def extract_boss(input_path, output_path, start_page=1, end_page=None):
    """
    Performs OCR on BOSS PDF page-by-page, storing progress in memory,
...
def main():
    input_file = "./data/raw/veducation_books/BOSS.pdf"
    output_file = "./data/output/veducation_books/boss_ocr.json"

    print("=" * 80)
    print("                NITYAGEETA - BOSS BOOK OCR EXTRACTOR")
    ...
    extract_boss(input_file, output_file, start_page=1, end_page=None)
    print("=" * 80)
