...
def extract_brahmacharya(input_path, output_path, start_page=1, end_page=None):
    """
    Performs OCR on Brahmacharya PDF page-by-page, storing progress in memory,
...
def main():
    input_file = "./data/raw/veducation_books/Brahmacharya-the-Ultimate-Action-Book-for-Brahmacharya.pdf"
    output_file = "./data/output/veducation_books/brahmacharya_ocr.json"

    print("=" * 80)
    print("                NITYAGEETA - BRAHMACHARYA OCR EXTRACTOR")
    ...
    extract_brahmacharya(input_file, output_file, start_page=1, end_page=None)
    print("=" * 80)
