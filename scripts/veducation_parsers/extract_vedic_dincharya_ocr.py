...
def extract_vedic_dincharya(input_path, output_path, start_page=1, end_page=None):
    """
    Performs OCR on Vedic Dincharya PDF page-by-page, storing progress in memory,
...
def main():
    input_file = "./data/raw/veducation_books/Vedic Dincharya.pdf"
    output_file = "./data/output/veducation_books/vedic_dincharya_ocr.json"

    print("=" * 80)
    print("                NITYAGEETA - VEDIC DINCHARYA OCR EXTRACTOR")
    ...
    extract_vedic_dincharya(input_file, output_file, start_page=1, end_page=None)
    print("=" * 80)
