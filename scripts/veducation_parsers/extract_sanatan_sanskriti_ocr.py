...
def extract_sanatan_sanskriti(input_path, output_path, start_page=1, end_page=None):
    """
    Performs OCR on Basics of Sanatan Sanskriti PDF page-by-page, storing progress in memory,
    ...
    for page_num in range(start_page, end_page + 1):
        ...
        try:
            ...
            # Periodically write progress every 10 pages
            if page_num % 10 == 0:
...
def main():
    input_file = "./data/raw/veducation_books/Basics of Sanatan Sanskriti.pdf"
    output_file = "./data/output/veducation_books/basics_of_sanatan_sanskriti_ocr.json"

    print("=" * 80)
    print("                NITYAGEETA - BASICS OF SANATAN SANSKRITI OCR")
    ...
    extract_sanatan_sanskriti(input_file, output_file, start_page=1, end_page=None)
    print("=" * 80)
